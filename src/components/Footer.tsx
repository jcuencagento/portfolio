...
function Footer() {
    ...
    return (
        <div className="relative bottom-0 m-auto mb-2 mt-6 flex w-4/5 justify-between lg:mb-4 lg:w-1/2">
            <div className="flex flex-row items-center space-x-1 font-semibold text-primary">
            ...
            <div className="flex gap-2 lg:gap-6">
                ...
                <a aria-label="Open code" href="https://github.com/jcuencagento/portfolio" rel="noreferrer" target="_blank">
                    <BiCodeAlt className="text-primary/60 transition-colors duration-100 hover:scale-110 hover:text-primary" size={22} />
                </a>
                ...
                <a aria-label="Linkedin" href="https://www.linkedin.com/in/javiercuencagento/" rel="noreferrer" target="_blank">
                    <BsLinkedin className="text-primary/60 transition-colors duration-100 hover:scale-110 hover:text-primary" size={20} />
                </a>
            </div>
        </div>
    );
